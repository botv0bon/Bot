...
async function formatAmmKeysById(id) {
    ...
    const marketAccount = await config_1.private_connection.getAccountInfo(marketId);
    ...
    const lpMintAccount = await config_1.private_connection.getAccountInfo(lpMint);
